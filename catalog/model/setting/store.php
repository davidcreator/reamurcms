 ...
 */
class Store extends \Reamur\System\Engine\Model {
	/**
	 * @param int $store_id
	 *
	 * @return array
	...
	public function createStoreInstance(int $store_id = 0, string $language = '', string $session_id = ''): object {
		...
		$language = new \Reamur\System\Library\Language($this->config->get('config_language'));
