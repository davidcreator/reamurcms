<?php
namespace Reamur\Catalog\Controller\Information;
/**
 * Class Contact
 *
 * @package Reamur\Catalog\Controller\Information
 */
class Contact extends \Reamur\System\Engine\Controller {
	/**
	 * @return void
	 */
	...
	public function send(): void {
		...
		if ((rms_strlen($this->request->post['enquiry']) < 10) || (rms_strlen($this->request->post['enquiry']) > 3000)) {
		...
		if (!$json) {
			if ($this->config->get('config_mail_engine')) {
				...
				$mail = new \Reamur\System\Library\Mail($this->config->get('config_mail_engine'), $mail_option);
