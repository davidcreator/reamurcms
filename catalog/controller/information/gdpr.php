 ...
 */
class Gdpr extends \Reamur\System\Engine\Controller {
	/**
	...
	*/
	...
	public function action(): void {
		...
		// Validate E-Mail
		if ((rms_strlen($email) > 96) || !filter_var($email, FILTER_VALIDATE_EMAIL)) {
		...
		if (!$json) {
			...
			if ($status) {
				$this->model_account_gdpr->addGdpr(rms_token(32), $email, $action);
			}
