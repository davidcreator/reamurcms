<?php
namespace Reamur\Catalog\Controller\Api\Account;
/**
 * Class Login
 *
 * @package Reamur\Catalog\Controller\Api\Account
 */
class Login extends \Reamur\System\Engine\Controller {
	/*
	 * Reamur\Catalog\Controller\Api\Account\Login.Index
	 *
	 * @Example
	 *
	 ...
	 * }
	 *
	 * $url = 'http://www.yourdomain.com/reamurcms-master/upload/index.php?route=api/sale/order.load&language=en-gb&store_id=0&order_id=1';
	 *
	 * $curl = curl_init();
	 *
	 * curl_setopt($curl, CURLOPT_URL, $url);
