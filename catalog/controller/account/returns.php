 ...
 */
class Returns extends \Reamur\System\Engine\Controller {
	/**
	 * @return void
	 */
	...
	public function save(): void {
		...
		if (!$json) {
			...
			if ((rms_strlen($this->request->post['telephone']) < 3) || (rms_strlen($this->request->post['telephone']) > 32)) {
				$json['error']['telephone'] = $this->language->get('error_telephone');
			}

			if ((rms_strlen($this->request->post['product']) < 1) || (rms_strlen($this->request->post['product']) > 255)) {
				$json['error']['product'] = $this->language->get('error_product');
			}

			if ((rms_strlen($this->request->post['model']) < 1) || (rms_strlen($this->request->post['model']) > 64)) {
