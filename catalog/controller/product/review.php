 ...
 */
class Review extends \Reamur\System\Engine\Controller {
	/**
	 * @return string
	 */
	public function index(): string {
		...
		$this->session->data['review_token'] = rms_token(32);
	...
	public function write(): void {
		...
		if ((rms_strlen($this->request->post['name']) < 3) || (rms_strlen($this->request->post['name']) > 25)) {
			$json['error']['name'] = $this->language->get('error_name');
		}

		if ((rms_strlen($this->request->post['text']) < 25) || (rms_strlen($this->request->post['text']) > 1000)) {
