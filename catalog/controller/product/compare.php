 ...
 */
class Compare extends \Reamur\System\Engine\Controller {
	/**
	 * @return void
	 */
		...
		foreach ($this->session->data['compare'] as $key => $product_id) {
			...
			if ($product_info) {
				...
				$data['products'][$product_id] = [
					...
					'price'        => $price,
					'special'      => $special,
					'description'  => rms_substr(strip_tags(html_entity_decode($product_info['description'], ENT_QUOTES, 'UTF-8')), 0, 200) . '..',
