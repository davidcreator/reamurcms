...
$_['text_cron_1']          = 'Cron Job\'s are scheduled tasks that are run periodically. To setup your servers to use cron job you can read the <a href="http://docs.reamurcms.com/extension/cron/" target="_blank" class="alert-link">ReamurCMS documentation</a> page.';
