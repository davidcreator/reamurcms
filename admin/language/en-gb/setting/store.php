...
$_['help_pagination']                  = 'Determines how many catalog site items are shown per page (products, categories, etc)';
...
$_['help_product_count']               = 'Show the number of products inside the subcategories in the storecatalog header category menu. Be warned, this will cause an extreme performance hit for stores with a lot of subcategories!';
