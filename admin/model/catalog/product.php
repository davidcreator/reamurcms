<?php
namespace Reamur\Admin\Model\Catalog;
/**
 * Class Product
 *
 * @package Reamur\Admin\Model\Catalog
 */
class Product extends \Reamur\System\Engine\Model {
	/**
	 * @param array $data
	 *
	 * @return int
    ...
    private function ensureMoocColumns(): void {
        $table = DB_PREFIX . "product";
        $columns = [
            'is_premium' => "ALTER TABLE `" . $table . "` ADD COLUMN `is_premium` TINYINT(1) NOT NULL DEFAULT 0 AFTER `status`",
            'owner_id' => "ALTER TABLE `" . $table . "` ADD COLUMN `owner_id` INT(11) DEFAULT NULL AFTER `manufacturer_id`",
