<?php
namespace Reamur\Admin\Model\Customer;
/**
 * Class Customer
 *
 * @package Reamur\Admin\Model\Customer
 */
class Customer extends \Reamur\System\Engine\Model {
	...
	public function getCustomerByEmail(string $email): array {
		$query = $this->db->query("SELECT DISTINCT * FROM `" . DB_PREFIX . "customer` WHERE LCASE(`email`) = '" . $this->db->escape(rms_strtolower($email)) . "'");
	...
	public function getTotalLoginAttempts(string $email): array {
		$query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "customer_login` WHERE `email` = '" . $this->db->escape(rms_strtolower($email)) . "'");
	...
	public function deleteLoginAttempts(string $email): void {
		$this->db->query("DELETE FROM `" . DB_PREFIX . "customer_login` WHERE `email` = '" . $this->db->escape(rms_strtolower($email)) . "'");
	}
}
