...
class Application extends \Reamur\System\Engine\Controller {
	...
	public function index(): void {
		// Url
		$this->registry->set('url', new \Reamur\System\Library\Url($this->config->get('site_url')));

		// Customer
		$this->registry->set('customer', new \Reamur\System\Library\Cart\Customer($this->registry));

		// Currency
		$this->registry->set('currency', new \Reamur\System\Library\Cart\Currency($this->registry));

		// Tax
		$this->registry->set('tax', new \Reamur\System\Library\Cart\Tax($this->registry));
