...
class Extension extends \Reamur\System\Engine\Controller {
	...
	public function index(): void {
		...
		foreach ($results as $result) {
			...
			$this->autoloader->register('Reamur\Admin\Controller\Extension\\' . $extension, DIR_EXTENSION . $result['code'] . '/admin/controller/');
			$this->autoloader->register('Reamur\Admin\Model\Extension\\' . $extension, DIR_EXTENSION . $result['code'] . '/admin/model/');
			$this->autoloader->register('Reamur\System\Library\Extension\\' . $extension, DIR_EXTENSION . $result['code'] . '/system/library/');
