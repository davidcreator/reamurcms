 ...
 */
class Notification extends \Reamur\System\Engine\Controller {
	/**
	 * @return void
	 */
	public function index(): void {
		if (empty($this->request->cookie['notification'])) {
			...
			// Gets the latest information from reamur.com about news, updates and security.
			curl_setopt($curl, CURLOPT_URL, REAMUR_SERVER . 'index.php?route=api/notification');
