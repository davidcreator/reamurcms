 ...
 */
class TaxClass extends \Reamur\System\Engine\Controller {
	/**
	 * @return void
	 */
	...
	public function save(): void {
		...
		if ((rms_strlen($this->request->post['title']) < 3) || (rms_strlen($this->request->post['title']) > 32)) {
			$json['error']['title'] = $this->language->get('error_title');
		}

		if ((rms_strlen($this->request->post['description']) < 3) || (rms_strlen($this->request->post['description']) > 255)) {
