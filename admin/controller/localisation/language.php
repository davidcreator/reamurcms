...
class Language extends \Reamur\System\Engine\Controller {
	...
	public function save(): void {
		...
		if ((rms_strlen($this->request->post['name']) < 1) || (rms_strlen($this->request->post['name']) > 32)) {
			$json['error']['name'] = $this->language->get('error_name');
		}

		if ((rms_strlen($this->request->post['code']) < 2) || (rms_strlen($this->request->post['code']) > 5)) {
			$json['error']['code'] = $this->language->get('error_code');
		}
		
		if ((rms_strlen($this->request->post['locale']) < 2) || (rms_strlen($this->request->post['locale']) > 255)) {
