<?php
namespace Reamur\Admin\Controller\Localisation;
/**
 * Class Location
 *
 * @package Reamur\Admin\Controller\Localisation
 */
class Location extends \Reamur\System\Engine\Controller {
	/**
	 * @return void
	 */
	...
	public function save(): void {
		...
		if ((rms_strlen($this->request->post['name']) < 3) || (rms_strlen($this->request->post['name']) > 32)) {
			$json['error']['name'] = $this->language->get('error_name');
		}

		if ((rms_strlen($this->request->post['address']) < 3) || (rms_strlen($this->request->post['address']) > 128)) {
