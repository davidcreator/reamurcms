...
class Api extends \Reamur\System\Engine\Controller {
	...
	public function save(): void {
		...
		if ((rms_strlen($this->request->post['username']) < 3) || (rms_strlen($this->request->post['username']) > 64)) {
			$json['error']['username'] = $this->language->get('error_username');
		}

		if ((rms_strlen($this->request->post['key']) < 64) || (rms_strlen($this->request->post['key']) > 256)) {
