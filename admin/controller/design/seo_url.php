<?php
namespace Reamur\Admin\Controller\Design;
/**
 * Class SEO URL
 *
 * @package Reamur\Admin\Controller\Design
 */
class SeoUrl extends \Reamur\System\Engine\Controller {
	/**
	 * @return void
	 */
	...
	public function save(): void {
		...
		if ((rms_strlen($this->request->post['key']) < 1) || (rms_strlen($this->request->post['key']) > 64)) {
			$json['error']['key'] = $this->language->get('error_key');
		}

		if ((rms_strlen($this->request->post['value']) < 1) || (rms_strlen($this->request->post['value']) > 255)) {
