 ...
 */
class Promotion extends \Reamur\System\Engine\Controller {
	/**
	 * @return string
	 */
	public function index(): string {
		...
		if (!$promotion) {
			...
			curl_setopt($curl, CURLOPT_URL, REAMUR_SERVER . 'index.php?route=api/recommended&type=' . $type . '&version=' . VERSION);
