 ...
 */
class Installer extends \Reamur\System\Engine\Controller {
	/**
	 * @return void
	 */
	...
	public function upload(): void {
		...
		if (isset($this->request->files['file']['name'])) {
			...
			if ((rms_strlen($filename) < 1) || (rms_strlen($filename) > 128)) {
	...
	public function uninstall(): void {
		...
		if ($extension_install_info) {
			if ($extension_install_info['code'] == 'reamur') {
	...
	public function delete(): void {
		...
		if ($extension_install_info && $extension_install_info['code'] == 'reamur') {
			$json['error'] = $this->language->get('error_default');
		}
