 ...
 */
class CustomField extends \Reamur\System\Engine\Controller {
	/**
	 * @return void
	 */
	...
	public function save(): void {
		...
		foreach ($this->request->post['custom_field_description'] as $language_id => $value) {
			if ((rms_strlen($value['name']) < 1) || (rms_strlen($value['name']) > 128)) {
			...
			if (isset($this->request->post['custom_field_value'])) {
				foreach ($this->request->post['custom_field_value'] as $custom_field_value_id => $custom_field_value) {
					foreach ($custom_field_value['custom_field_value_description'] as $language_id => $custom_field_value_description) {
						if ((rms_strlen($custom_field_value_description['name']) < 1) || (rms_strlen($custom_field_value_description['name']) > 128)) {
