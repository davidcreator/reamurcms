 ...
 */
class Developer extends \Reamur\System\Engine\Controller {
	/**
	 * @return void
	 */
	...
	public function sass(): void {
		...
		if (!$json) {
			...
			if (is_file($file) && is_file(DIR_APPLICATION . 'view/css/scss/bootstrap.scss')) {
				unlink($file);
			}
			 
			$files = glob(DIR_CATALOG  . 'view/theme/*/css/scss/bootstrap.scss');
			...
			$files = glob(DIR_CATALOG  . 'view/theme/*/css/stylesheet.scss');
