 ...
 */
class ColumnLeft extends \Reamur\System\Engine\Controller {
	/**
	 * @return string
	 */
		...
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ((string)$this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'cms/topic')) {
				$cms[] = [
					...
					'href'		=> $this->url->link('cms/topic', 'user_token=' . $this->sssion->data['user_token']),
					'children'  => []
				];
			}
			...
			if ($this->user->hasPermission('access', 'cms/blog_post')) {
				$cms[] = [
					...
					'href'     => $this->url->link('cms/blog_post_list', 'user_token=' . $this->session->data['user_token']),
					'children' => []
				];
			}
			...
			// Blog Media
			if ($this->user->hasPermission('access', 'cms/blog_media')) {
				$cms[] = [
					'name'     => $this->language->get('text_blog_media'),
					'href'     => $this->url->link('cms/blog_media', 'user_token=' . $this->session->data['user_token']),
					'children' => []
				];
			}
			...
			if ($this->user->hasPermission('access', 'cms/blog_analytics')) {
				$blog_report[] = [
					'name'     => $this->language->get('text_blog_analytics'),
					'href'     => $this->url->link('cms/blog_analytics', 'user_token=' . $this->session->data['user_token']),
					'children' => []
				];
			}
			...
			if ($blog_report) {
				$cms[] = [
					...
					'href'     => '',
					'children' => $blog_report
				];
			}

			// Blog Settings
			if ($this->user->hasPermission('access', 'cms/blog_settings')) {
				$cms[] = [
			...
			if ($this->user->hasPermission('access', 'tool/database')) {
				$maintenance[] = [
