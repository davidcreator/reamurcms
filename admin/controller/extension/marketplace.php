 ...
 * Class Marketplace
 *
 * @package Reamur\Admin\Controller\Extension
 */
class Marketplace extends \Reamur\System\Engine\Controller {
	...
	public function install(): void {
		...
		if (!$json) {
			...
			$this->autoloader->register('Reamur\Admin\Controller\Extension\\' . $namespace, DIR_EXTENSION . $extension . '/admin/controller/');
			$this->autoloader->register('Reamur\Admin\Model\Extension\\' . $namespace, DIR_EXTENSION . $extension . '/admin/model/');
			$this->autoloader->register('Reamur\System\Extension\\' . $namespace, DIR_EXTENSION . $extension . '/system/');
