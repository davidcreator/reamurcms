 ...
 * Class Setting
 *
 * @package Reamur\Admin\Controller\Setting
 */
class Setting extends \Reamur\System\Engine\Controller {
	...
	public function save(): void {
		...
		if ((rms_strlen($this->request->post['config_owner']) < 3) || (rms_strlen($this->request->post['config_owner']) > 64)) {
			$json['error']['owner'] = $this->language->get('error_owner');
		}

		if ((rms_strlen($this->request->post['config_address']) < 3) || (rms_strlen($this->request->post['config_address']) > 256)) {
			$json['error']['address'] = $this->language->get('error_address');
		}

		if ((rms_strlen($this->request->post['config_email']) > 96) || !filter_var($this->request->post['config_email'], FILTER_VALIDATE_EMAIL)) {
			$json['error']['email'] = $this->language->get('error_email');
		}

		if ((rms_strlen($this->request->post['config_telephone']) < 3) || (rms_strlen($this->request->post['config_telephone']) > 32)) {
		...
		if ((rms_strlen($this->request->post['config_encryption']) < 32) || (rms_strlen($this->request->post['config_encryption']) > 1024)) {
