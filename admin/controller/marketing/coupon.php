...
class Coupon extends \Reamur\System\Engine\Controller {
	...
	public function save(): void {
		...
		if ((rms_strlen($this->request->post['name']) < 3) || (rms_strlen($this->request->post['name']) > 128)) {
			$json['error']['name'] = $this->language->get('error_name');
		}

		if ((rms_strlen($this->request->post['code']) < 3) || (rms_strlen($this->request->post['code']) > 20)) {
