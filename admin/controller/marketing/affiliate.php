<?php
namespace Reamur\Admin\Controller\Marketing;
/**
 * Class Affiliate
 *
 * @package Reamur\Admin\Controller\Marketing
 */
class Affiliate extends \Reamur\System\Engine\Controller {
	...
	public function save(): void {
		...
		} elseif ($this->request->post['payment_method'] == 'paypal' && ((rms_strlen($this->request->post['paypal']) > 96) || !filter_var($this->request->post['paypal'], FILTER_VALIDATE_EMAIL))) {
	...
	/**
	 * @return \Reamur\System\Engine\Action|void
	 */
	public function csv() {
		$this->load->language('marketing/affiliate');
