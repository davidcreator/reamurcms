<?php
//
// Command line tool for installing cloud version of reamurcms
//
// Usage:
//
//   Cloud Install
...
define('DIR_REAMUR', DIR_REAMUR . 'system/');
 ...
 *
 */
class CliCloud extends \Reamur\System\Engine\Controller {
	/**
	 * @return void
	 */
	...
	public function install($argv): string {
		...
		$file = DIR_REAMUR . 'install/reamurcms.sql';
