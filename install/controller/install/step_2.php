 ...
 */
class Step2 extends \Reamur\System\Engine\Controller {
	/**
	 * @var array
	 */
	private array $error = [];
	...
	public function index(): void {
		...
		$data['catalog_config'] = DIR_REAMUR . 'config.php';
		$data['admin_config'] = DIR_REAMUR . 'admin/config.php';
		...
		// admin configs
		if (!is_file(DIR_REAMUR . 'admin/config.php')) {
