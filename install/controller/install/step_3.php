 ...
 */
class Step3 extends \Reamur\System\Engine\Controller {
	/** @var array */
	private array $error = [];
	...
	public function index(): void {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$output .= '// HTTP' . "\n";
			$output .= 'define(\'HTTP_SERVER\', \'' . HTTP_REAMUR . '\');' . "\n\n";
			...
			$output .= '// HTTP' . "\n";
			$output .= 'define(\'HTTP_SERVER\', \'' . HTTP_REAMUR . 'admin/\');' . "\n";
			$output .= 'define(\'HTTP_CATALOG\', \'' . HTTP_REAMUR . '\');' . "\n\n";
			...
			$output .= '// ReamurCMS API' . "\n";
			$output .= 'define(\'REAMUR_SERVER\', \'https://reamurcms.com/\');' . "\n";
	...
	private function validate(): bool {
		...
		if (!is_writable(DIR_REAMUR . 'config.php')) {
			$this->error['warning'] = $this->language->get('error_config') . DIR_REAMUR . 'config.php!';
		}

		if (!is_writable(DIR_REAMUR . 'admin/config.php')) {
			$this->error['warning'] = $this->language->get('error_config') . DIR_REAMUR . 'admin/config.php!';
		}
