<?php
namespace Reamur\Install\Controller\ColumnLeft;
/** 
 * Class ColumnLeft
 * @package Reamur\Install\Controller\ColumnLeft
 */
class ColumnLeft extends \Reamur\System\Engine\Controller {
    ...
    public function index(): mixed{
        ...
        $data['texte_installation'] = $this->language->get('text_installation');
        ...
        if (isset($this->session->data['language'])) {
            $data['code'] = $this->seesion->data['language'];
        } else {
