<?php
/**
 * Landpage Extension Installer
 *
 * Usage (CLI):
 *   php install/extensions/landpage-extension.php
 *
 * Requirements:
 * - Application already installed (config.php present)
 * - Database credentials defined in config.php
 * - SQL bundle install/sql/landpage_tables.sql available
 */

// Resolve base dir (repo root)
$dirReamur = str_replace('\\', '/', realpath(__DIR__ . '/..')) . '/';
// config.php sits one level above install/
...
echo "SUCCESS: Landpage extension installed. {$executed} statements executed.\n";
