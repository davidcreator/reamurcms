<?php
/**
 * Blog Extension Installer
 *
 * Usage (CLI):
 *   php install/extensions/blog-extension.php
 *
 * Requirements:
 * - Application already installed (config.php present)
 * - Database credentials defined in config.php
 * - SQL bundle install/reamurcms-blog-extension.sql available
 */
...
echo "SUCCESS: Blog extension installed. {$executed} statements executed.\n";
