<?php
namespace Reamur\Admin\Controller\Extension\Reamur\Payment;
/**
 * Class Bank Transfer
 *
 * @package Reamur\Admin\Controller\Extension\Reamur\Payment
 */
class BankTransfer extends \Reamur\System\Engine\Controller {
	/**
	 * @return void
	 */
	public function index(): void {
		$this->load->language('extension/reamur/payment/bank_transfer');
		...
		$data['breadcrumbs'][] = [
			...
			'href' => $this->url->link('extension/reamur/payment/bank_transfer', 'user_token=' . $this->session->data['user_token'])
		];

		$data['save'] = $this->url->link('extension/reamur/payment/bank_transfer.save', 'user_token=' . $this->session->data['user_token']);
		...
		$this->response->setOutput($this->load->view('extension/reamur/payment/bank_transfer', $data));
	}
	...
	public function save(): void {
		...
		if (!$this->user->hasPermission('modify', 'extension/reamur/payment/bank_transfer')) {
