 ...
 * Class Fixer
 *
 * @package Reamur\Admin\Controller\Extension\Reamur\Currency
 */
class Fixer extends \Reamur\System\Engine\Controller {
	/**
	 * @return void
	 */
	public function index(): void {
		$this->load->language('extension/reamur/currency/fixer');
		...
		$data['breadcrumbs'][] = [
			...
			'href' => $this->url->link('extension/reamur/currency/fixer', 'user_token=' . $this->session->data['user_token'])
		];

		$data['save'] = $this->url->link('extension/reamur/currency/fixer.save', 'user_token=' . $this->session->data['user_token']);
		...
		$this->response->setOutput($this->load->view('extension/reamur/currency/fixer', $data));
	}
	...
	public function save(): void {
		...
		if (!$this->user->hasPermission('modify', 'extension/reamur/currency/fixer')) {
