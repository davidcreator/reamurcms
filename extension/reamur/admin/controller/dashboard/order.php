 ...
 */
class Order extends \Reamur\System\Engine\Controller {
	/**
	 * @return void
	 */
	public function index(): void {
		$this->load->language('extension/reamur/dashboard/order');
		...
		$data['breadcrumbs'][] = [
			...
			'href' => $this->url->link('extension/reamur/dashboard/order', 'user_token=' . $this->session->data['user_token'])
		];

		$data['save'] = $this->url->link('extension/reamur/dashboard/order.save', 'user_token=' . $this->session->data['user_token']);
		...
		$this->response->setOutput($this->load->view('extension/reamur/dashboard/order_form', $data));
	}
	...
	public function save(): void {
		...
		if (!$this->user->hasPermission('modify', 'extension/reamur/dashboard/order')) {
	...
	public function dashboard(): string {
		...
		return $this->load->view('extension/reamur/dashboard/order_info', $data);
	}
}
