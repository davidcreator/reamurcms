...
class Customer extends \Reamur\System\Engine\Controller {
	...
	public function index(): void {
		$this->load->language('extension/reamur/dashboard/customer');
		...
		$data['breadcrumbs'][] = [
			...
			'href' => $this->url->link('extension/reamur/dashboard/customer', 'user_token=' . $this->session->data['user_token'])
		];

		$data['save'] = $this->url->link('extension/reamur/dashboard/customer.save', 'user_token=' . $this->session->data['user_token']);
		...
		$this->response->setOutput($this->load->view('extension/reamur/dashboard/customer_form', $data));
	}
	...
	public function save(): void {
		...
		if (!$this->user->hasPermission('modify', 'extension/reamur/dashboard/customer')) {
	...
	public function dashboard(): string {
		...
		return $this->load->view('extension/reamur/dashboard/customer_info', $data);
	}
}
