 ...
 */
class Activity extends \Reamur\System\Engine\Controller {
	/**
	 * @return void
	 */
	public function index(): void {
		$this->load->language('extension/reamur/dashboard/activity');
		...
		$data['breadcrumbs'][] = [
			...
			'href' => $this->url->link('extension/reamur/dashboard/activity', 'user_token=' . $this->session->data['user_token'])
		];

		$data['save'] = $this->url->link('extension/reamur/dashboard/activity.save', 'user_token=' . $this->session->data['user_token']);
		...
		$this->response->setOutput($this->load->view('extension/reamur/dashboard/activity_form', $data));
	}
	...
	public function save(): void {
		...
		if (!$this->user->hasPermission('modify', 'extension/reamur/dashboard/activity')) {
	...
	public function dashboard(): string {
		...
		$this->load->model('extension/reamur/report/activity');

		$results = $this->model_extension_reamur_report_activity->getActivities();
		...
		return $this->load->view('extension/reamur/dashboard/activity_info', $data);
	}
}