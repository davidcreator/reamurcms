 ...
 */
class Online extends \Reamur\System\Engine\Controller {
	/**
	 * @return void
	 */
	public function index(): void {
		$this->load->language('extension/reamur/dashboard/online');
		...
		$data['breadcrumbs'][] = [
			...
			'href' => $this->url->link('extension/reamur/dashboard/online', 'user_token=' . $this->session->data['user_token'])
		];

		$data['save'] = $this->url->link('extension/reamur/dashboard/online.save', 'user_token=' . $this->session->data['user_token']);
		...
		$this->response->setOutput($this->load->view('extension/reamur/dashboard/online_form', $data));
	}
	...
	public function save(): void {
		...
		if (!$this->user->hasPermission('modify', 'extension/reamur/dashboard/online')) {
	...
	public function dashboard(): string {
		...
		return $this->load->view('extension/reamur/dashboard/online_info', $data);
	}
}
