<?php
namespace Reamur\Admin\Controller\Extension\Reamur\Total;
/**
 * Class Low Order Fee
 *
 * @package Reamur\Admin\Controller\Extension\Reamur\Total
 */
class LowOrderFee extends \Reamur\System\Engine\Controller {
	/**
	 * @return void
	 */
	public function index(): void {
		$this->load->language('extension/reamur/total/low_order_fee');
		...
		$data['breadcrumbs'][] = [
			...
			'href' => $this->url->link('extension/reamur/total/low_order_fee', 'user_token=' . $this->session->data['user_token'])
		];

		$data['save'] = $this->url->link('extension/reamur/total/low_order_fee.save', 'user_token=' . $this->session->data['user_token']);
		...
		$this->response->setOutput($this->load->view('extension/reamur/total/low_order_fee', $data));
	}
	...
	public function save(): void {
		...
		if (!$this->user->hasPermission('modify', 'extension/reamur/total/low_order_fee')) {
