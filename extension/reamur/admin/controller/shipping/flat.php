 ...
 */
class Flat extends \Reamur\System\Engine\Controller {
	/**
	 * index
	 *
	 * @return void
	...
	public function index(): void {
		...
		$data['breadcrumbs'][] = ['text' => $this->language->get('heading_title'), 'href' => $this->url->link('extension/reamur/shipping/flat', 'user_token=' . $this->session->data['user_token'])];

		$data['save'] = $this->url->link('extension/reamur/shipping/flat.save', 'user_token=' . $this->session->data['user_token']);
		...
		$this->response->setOutput($this->load->view('extension/reamur/shipping/flat', $data));
	}
	...
	public function save(): void {
		...
		if (!$this->user->hasPermission('modify', 'extension/reamur/shipping/flat')) {
