<?php
namespace Reamur\Catalog\Controller\Extension\Reamur\Captcha;
/**
 * Class Basic
 *
 * @package
...
class Basic extends \Reamur\System\Engine\Controller {
	...
	public function index(): string {
		...
		$this->session->data['captcha'] = substr(rms_token(100), rand(0, 94), 6);

		return $this->load->view('extension/reamur/captcha/basic', $data);
	}
