...
class Voucher extends \Reamur\System\Engine\Controller {
	...
	public function index(): string {
		if ($this->config->get('total_voucher_status')) {
			...
			$data['save'] = $this->url->link('extension/reamur/total/voucher.save', 'language=' . $this->config->get('config_language'), true);
			...
			return $this->load->view('extension/reamur/total/voucher', $data);
		}
