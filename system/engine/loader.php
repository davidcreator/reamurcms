 ...
 */
 ...
 class Loader {
     ...
     public function controller(string $route, mixed ...$args): mixed {
         ...
         $action = new \Reamur\System\Engine\Action($route);
     ...
     public function model(string $route): void {
         ...
         $class = 'Reamur\\' . $this->config->get('application') . '\Model\\' . str_replace(['_', '/'], ['', '\\'], ucwords($route, '_/'));
         ...
         if (!$this->registry->has($key)) {
             if (class_exists($class)) {
                 ...
                 $proxy = new \Reamur\System\Engine\Proxy();
