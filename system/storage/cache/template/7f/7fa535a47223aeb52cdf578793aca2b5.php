...
class __TwigTemplate_2906145c92dd9fcf459d9dd4af7cf447 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 1
        yield "<form id=\"form-information\" method=\"post\" data-rms-toggle=\"ajax\" data-rms-load=\"";
        yield ($context["action"] ?? null);
        yield "\" data-rms-target=\"#information\">
        ...
        if ((($tmp = ($context["informations"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["information"]) {
              ...
              <td class=\"text-start\">";
                ...
                ";
                // line 19
                if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["information"], "status", [], "any", false, false, false, 19)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 20
  ...
  <div class=\"row\">
    ...
    {
        return new Source("", "admin/view/template/catalog/information_list.twig", "E:\\wamp64\\www\\reamur\\admin\\view\\template\\catalog\\information_list.twig");
    }
}
