...
class __TwigTemplate_6463137dcd41f9995572cefc65389e6a extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 1
        yield "<form id=\"form-category\" method=\"post\" data-rms-toggle=\"ajax\" data-rms-load=\"";
        yield ($context["action"] ?? null);
        yield "\" data-rms-target=\"#category\">
        ...
        if ((($tmp = ($context["categories"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["category"]) {
              ...
              <td class=\"text-start\">";
                ...
                ";
                // line 19
                if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["category"], "status", [], "any", false, false, false, 19)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 20
...
";
    ...
    {
        return new Source("", "admin/view/template/catalog/category_list.twig", "E:\\wamp64\\www\\reamur\\admin\\view\\template\\catalog\\category_list.twig");
    }
}
