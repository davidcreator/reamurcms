	...
	public function index(): string {
		if ($this->config->get('total_reward_status')) {
			...
			if ($available && $points_total) {
				...
				$data['save'] = $this->url->link('extension/reamur/total/reward.save', 'language=' . $this->config->get('config_language'), true);
				...
				return $this->load->view('extension/reamur/total/reward', $data);
			}
		}
